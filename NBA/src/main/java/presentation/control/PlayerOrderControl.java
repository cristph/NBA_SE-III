...
public class PlayerOrderControl implements ControlService{
	...
	/*
	 * (non-Javadoc)
	 * @see presentation.control.ControlService#getData(java.lang.String, java.lang.String, java.lang.String)
	 * order=upToDown or downToUp
	 * string为平均数据 or 总数据
	 * String2 为查看的title
	 */
	public String[][] getData(String order, String string, String string2) {
		String[][] t = new String[30][28];
		for(int i=0;i<30;i++){
			for(int j=0;j<28;j++){
				t[i][j] = "d";
			}
